	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs = con.consulta("SELECT * FROM  ("
					...
					+ "LEFT JOIN unidade ON unidade.codigo = controle_funcionarioterceirizado.unidade_codigo LEFT JOIN setor ON setor.codigo = controle_funcionarioterceirizado.setor_codigo"
					+ " UNION ALL SELECT UPPER(nomeCompleto) as UppercasenomeCompleto, cpf, unidadeNome, setorNome, 'SERVIDOR' as Tipo, 'N/D' as hrContrato, 'N/D' as nomeFantasia, descricao FROM funcionariosuf_servidores "
					...
					+ " UNION ALL SELECT UPPER(nomeCompleto) as UppercasenomeCompleto, cpf, unidadeNome, setorNome, 'ESTAGIÁRIO' as Tipo, 'N/D' as hrContrato, 'N/D' as nomeFantasia, 'N/D' as descricao FROM funcionariosuf_estagiarios "
					...
					+ "LEFT JOIN setor ON setor.codigo = funcionariosuf_estagiarios.setor_codigo"
